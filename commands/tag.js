...
export async function tagall(client, message) {
    ...
    try {
        ...
        await client.sendMessage(remoteJid, {
            text: `╭─⌈ 🚀 GOLDEN-MD-V1 Broadcast ⌋\n│\n${text}\n│\n╰─⌊ Powered by The GoldenBoy ⌉`,
...
export async function tagadmin(client, message) {
    ...
    try {
        ...
        const text = `╭─⌈ 🛡️ GOLDEN-MD-V1 Alert ⌋\n│ Admin Alert\n│\n${admins.map(user => `@${user.split('@')[0]}`).join('\n')}\n│\n╰─⌊ The GoldenBoy Control ⌉`
...
export async function tag(client, message) {
    ...
    try {
        ...
        const text = parts.slice(1).join(' ') || 'GOLDEN-MD-V1 Alert'
